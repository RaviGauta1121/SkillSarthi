'use client'
import "@/screens/Resume/ResumeContainer/ResumeContainer.scss";
...
import ContactInfoValidationSchema from "@/components/forms/ContactInfoValidationSchema";
...
const Contact = () => {
  ...
  const saveContactInfo = (values, { setSubmitting }) => {
    try {
      ...
      navigate.push("/resume/education/tips");
    } catch (error) {
      console.log(error);
    } finally {
      setSubmitting(false);
        ...
        <Form>
          <div className="resume-board-block resume-block-contact">
              ...
              <div className="resume-row">
                <div className="resume-img">
                  <div className="resume-img-preview">
                    {imagePreview ? (
                      <img src={imagePreview} alt="Uploaded" height={100} width={100}  />
                    ) : contactInfoData?.uploadImage ? (
                      <img src={contactInfoData.uploadImage} height={100} width={100}  alt="Uploaded" />
                    ) : (
                      
                      <img src="/assets/images/logo.png" height={100} width={100} alt="Default" />
                    )}
                  </div>
                  <button
                    type="button"
            ...
            <div className="resume-block-bottom">
              <button
                type="button"
                className="resume-preview-btn  btn-outline border-effect"
              >
                <span className="btn-text">Preview</span>
              </button>
              <button
                type="submit"
                className="resume-next-btn  text-pink-800 border-effect"
              >
