...
import WorkHistoryValidationSchema from "../../../../components/forms/WorkHistoryValidationSchema";
...
// Dynamically load components that require client-side rendering
const ReactQuill = dynamic(() => import("react-quill"), { ssr: false });
const ResumeTop = dynamic(
  () => import("../../../../components/screens/resume/ResumeTop/ResumeTop"),
  { ssr: false }
);
...
const WorkHistoryEdit = () => {
  ...
  // Fetch work history from the Redux store
  ...
  // Initialize form state based on the fetched work history
  const initialState = {
  ...
  const updateData = async (values, { setSubmitting }) => {
    try {
      ...
      await dispatch(updateWorkHistoryInfo({ id, data: workHistoryInfoData }));
      navigate.push("/resume/workhistory/list");
    } catch (error) {
      console.error(error);
    } finally {
      setSubmitting(false);
  ...
  // Handle checkbox for "Currently Working" and adjust the end date accordingly
